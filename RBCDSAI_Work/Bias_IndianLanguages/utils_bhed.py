...
def expb1(pipe,examples, df_path, lang_more, lang_less,biased_response,hint, pred_file_path, opt1, opt2,type =1,br = False):
...
def expb2(pipe,examples, df_path, lang_more, lang_less,biased_response,hint, pred_file_path, opt1, opt2,type=1, br = False):
...
def expb3(pipe,examples, df_path, lang_more, lang_less,biased_response,hint, pred_file_path, opt1, opt2, type=1, br = False):
...
def expb4(pipe,examples, df_path, lang_more, lang_less,biased_response,hint, pred_file_path, opt1, opt2,type=1, br = False):
...
def expb5(pipe,examples, df_path, lang_more, lang_less,biased_response,hint, pred_file_path, opt1, opt2,type=1, br = False):
