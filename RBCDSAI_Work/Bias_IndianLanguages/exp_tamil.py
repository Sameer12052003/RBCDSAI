...
print("Experiment 2\n")
expe2 = exp2(pipe,examples,df_path,"modified_tam_sent_more","modified_tam_sent_less",biased_response,
    hint,"Tamil_prediction(2).csv", '1)','2)')

print("Experiment 3\n")
expe3 = exp3(pipe,examples,df_path,"modified_tam_sent_more","modified_tam_sent_less",biased_response,
    hint,"Tamil_prediction(3).csv", '1)','2)')

print("Experiment 4\n")
expe4  = exp4(pipe,examples,df_path,"modified_tam_sent_more","modified_tam_sent_less",biased_response,
    hint,"Tamil_prediction(4).csv", '1)','2)')

print("Experiment 5\n")
expe5 = exp5(pipe,examples,df_path,"modified_tam_sent_more","modified_tam_sent_less",biased_response,
    hint,"Tamil_prediction(5).csv", '1)','2)')

print("Experiment 6\n")
expe6 = exp1(pipe,examples2,df_path,"modified_tam_sent_more","modified_tam_sent_less",biased_response,
    hint,"Tamil_prediction(6).csv", 'அ)','பி)')

print("Experiment 7\n")
expe7 = exp2(pipe,examples2,df_path,"modified_tam_sent_more","modified_tam_sent_less",biased_response,
    hint,"Tamil_prediction(7).csv", 'அ)','பி)')

print("Experiment 8\n")
expe8 = exp3(pipe,examples2,df_path,"modified_tam_sent_more","modified_tam_sent_less",biased_response,
    hint,"Tamil_prediction(8).csv", 'அ)','பி)')

print("Experiment 9\n")
expe9 = exp4(pipe,examples2,df_path,"modified_tam_sent_more","modified_tam_sent_less",biased_response,
    hint,"Tamil_prediction(9).csv", 'அ)','பி)')

print("Experiment 10\n")
expe10 = exp5(pipe,examples2,df_path,"modified_tam_sent_more","modified_tam_sent_less",biased_response,
    hint,"Tamil_prediction(10).csv", 'அ)','பி)')
