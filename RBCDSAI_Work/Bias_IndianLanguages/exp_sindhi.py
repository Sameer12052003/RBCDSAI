...
print("Experiment 1\n")
expe1 = exp1(pipe,examples,df_path,"sindhi_more","sindhi_less",biased_response,
    hint,"Sindhi_prediction(1).csv", '1)','2)')

print("Experiment 2\n")
expe2 = exp2(pipe,examples,df_path,"sindhi_more","sindhi_less",biased_response,
    hint,"Sindhi_prediction(2).csv", '1)','2)')

print("Experiment 3\n")
expe3 = exp3(pipe,examples,df_path,"sindhi_more","sindhi_less",biased_response,
    hint,"Sindhi_prediction(3).csv", '1)','2)')

print("Experiment 4\n")
expe4  = exp4(pipe,examples,df_path,"sindhi_more","sindhi_less",biased_response,
    hint,"Sindhi_prediction(4).csv", '1)','2)')

print("Experiment 5\n")
expe5 = exp5(pipe,examples,df_path,"sindhi_more","sindhi_less",biased_response,
    hint,"Sindhi_prediction(5).csv", '1)','2)')

print("Experiment 6\n")
expe6 = exp1(pipe,examples2,df_path,"sindhi_more","sindhi_less",biased_response,
    hint2,"Sindhi_prediction(6).csv", 'i)','ii)',type=2)

print("Experiment 7\n")
expe7 = exp2(pipe,examples2,df_path,"sindhi_more","sindhi_less",biased_response,
    hint2,"Sindhi_prediction(7).csv", 'i)','ii)',type=2)

print("Experiment 8\n")
expe8 = exp3(pipe,examples2,df_path,"sindhi_more","sindhi_less",biased_response,
    hint2,"Sindhi_prediction(8).csv", 'i)','ii)',type=2)

print("Experiment 9\n")
expe9 = exp4(pipe,examples2,df_path,"sindhi_more","sindhi_less",biased_response,
    hint2,"Sindhi_prediction(9).csv", 'i)','ii)',type=2)

print("Experiment 10\n")
expe10 = exp5(pipe,examples2,df_path,"sindhi_more","sindhi_less",biased_response,
    hint2,"Sindhi_prediction(10).csv", 'i)','ii)',type=2)
