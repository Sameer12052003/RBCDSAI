...
import gc
import numpy as np
from utils_spice import expb1, expb2, expb3, expb4, expb5,expbn1
...
df_path = "/home/ic40844/myenv/Bias_IndianLanguages/Bias_IndianLanguages/SPICE_dataset/SPICE_Konkani.csv"
...
df.to_csv("SPICE_Konkani_Results.csv")