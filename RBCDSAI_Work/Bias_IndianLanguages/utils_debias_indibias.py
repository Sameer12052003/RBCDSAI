...
import numpy as np 
# from exp_hindi import biased_response
...
def exp1(examples, df_path, lang_more, lang_less,biased_response,hint1, hint2, pred_file_path, opt1, opt2,probs_prior,type =1,br = False):
    ...
    for i in range(df.shape[0]):
        ...
        response = biased_response(hint1, hint2, input, examples, probs_prior)
...
def exp2(examples, df_path, lang_more, lang_less,biased_response,hint1,hint2, pred_file_path, opt1, opt2,probs_prior,type=1, br = False):
