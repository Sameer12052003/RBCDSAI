...
pipe = pipeline("text-generation", model=model_name, device=0)  # Use device=-1 for CPU
...
expe1 = exp1(pipe,examples,df_path,"modified_eng_sent_more","modified_eng_sent_less",biased_response,
    hint,"/home/ic40844/myenv/Bias_IndianLanguages/Bias_IndianLanguages/IndiBias_English_Meta/English_prediction(1).csv", '1)','2)')

print("Experiment 2\n")
expe2 = exp2(pipe,examples,df_path,"modified_eng_sent_more","modified_eng_sent_less",biased_response,
    hint,"/home/ic40844/myenv/Bias_IndianLanguages/Bias_IndianLanguages/IndiBias_English_Meta/English_prediction(2).csv", '1)','2)')
...
df.to_csv("/home/ic40844/myenv/Bias_IndianLanguages/Bias_IndianLanguages/IndiBias_English_Meta/English_Meta_results.csv")
